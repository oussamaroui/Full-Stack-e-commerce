      ...
      <div id="foooter-bottom">
        ...
        <hr className="seprator_line"></hr>
            <h3 className="footer_heading">Help</h3>
                {/* <a href="/Contact" class="bottom-display-points-link">
                    <div class="bottom-display-points">Contact Us</div>
                </a> */}
            
                <a href="/Shop" class="bottom-display-points-link">
                    <div class="bottom-display-points">Shop</div>
                </a>
        ...
        <hr className="seprator_line"></hr>
            <h3 className="footer_heading">Want More?</h3>
                <a href="/About" class="bottom-display-points-link">
